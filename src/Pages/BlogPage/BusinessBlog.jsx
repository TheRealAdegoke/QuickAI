...
const BusinessBlog = () => {
  ...
  const components = {
    h1: ({ children }) => (
      <h1 className="text-6xl font-extrabold text-purple-200 mb-6 mt-8 max-md:text-lg capitalize">
        {children}
      </h1>
    ),
    h2: ({ children }) => (
      <h2 className="text-2xl font-semibold text-[#ffffff8c] mb-5 mt-6 text-center max-md:text-lg capitalize">
        {children}
      </h2>
    ),
    h3: ({ children }) => (
