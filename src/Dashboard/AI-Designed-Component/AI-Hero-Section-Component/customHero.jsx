  ...
  return (
    <>
      <section className="text-black my-5">
        <h1 className="text-5xl text-[rgb(33,37,41)] PC:text-6xl font-extrabold text-center smallDevice:text-4xl phone:max-w-[350px] tablet:max-w-[400px] max-w-[500px] mx-auto my-3">
          {text.prompt}
        </h1>

        <p className="text-xl text-[rgb(52,58,64)] font-medium text-center phone:max-w-[350px] tablet:max-w-[400px] max-w-[500px] mx-auto">
          {text.description}
        </p>
    ...
    <>
      <section className="text-black mb-3 flex justify-between mobile:flex-col px-5">
        <div className="w-[45%] mobile:w-full mt-9">
          <h1 className="text-5xl text-[rgb(33,37,41)] font-extrabold text-center smallDevice:text-4xl phone:max-w-[350px] tablet:max-w-[400px] max-w-[500px] mx-auto mb-3">
            {text.prompt}
          </h1>
  ...
  return (
    <>
      <section className="text-black mb-3 flex flex-row-reverse justify-between mobile:flex-col px-5">
        <div className="w-[45%] mobile:w-full mt-9">
          <h1 className="text-4xl text-[rgb(33,37,41)] font-extrabold text-center smallDevice:text-4xl phone:max-w-[350px] tablet:max-w-[400px] max-w-[500px] mx-auto mb-3">
            {text.prompt}
          </h1>
