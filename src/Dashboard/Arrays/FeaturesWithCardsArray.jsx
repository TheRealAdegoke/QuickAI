...
export const featuresWithCardsComponent = ({ text, isMobile }) => {
  return [
    <section
      className={`${
        isMobile ? "flex-col" : ""
      } text-black w-[90%] mx-auto my-24 flex max-lg:flex-col justify-between max-w-[1000px]`}
    >
      <div
        className={`${
          isMobile ? "w-full" : ""
    ...
    <section
      ...
      } text-black w-[90%] mx-auto my-24 flex flex-row-reverse max-lg:flex-col-reverse justify-between max-w-[1000px]`}
    >
      <div
        className={`${
          isMobile ? "w-full" : ""
    ...
    <section
      className={`${
        isMobile ? "flex-col" : ""
      } text-black w-[90%] mx-auto my-24 flex flex-row-reverse max-lg:flex-col justify-between max-w-[1000px]`}
    >
      <div
        className={`${
          isMobile ? "w-full" : ""
