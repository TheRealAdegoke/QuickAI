        ...
        >
          <div className="flex flex-col justify-start items-start mt-8 w-[35%] max-w-[280px] max-lg:w-[90%]">
            ...
            <button
              ...
              style={getStyle(`features-button-${index + 1}`, uniqueId)}
            >
              <span
          ...
          <div className="my-10 flex justify-between flex-wrap max-[594px]:flex-col gap-8 w-full max-[594px]:w-full">
            <div
              ...
              className={`${
                isMobile ? "w-[45%]" : ""
              } flex flex-col gap-2 justify-start items-start text-left text-black w-[30%] max-w-[300px] max-[594px]:w-full max-lg:w-[45%] rounded-xl px-4 py-3`}
...
export default FeatureComponentSix;
