export const featuresComponents = () => {
    return [
      <section className="text-black my-14 max-w-[1000px] mx-auto">
      ...
      <section className="text-black my-14 max-w-[1000px] mx-auto flex max-lg:flex-col gap-5 max-lg:gap-0 items-start max-lg:px-6">
