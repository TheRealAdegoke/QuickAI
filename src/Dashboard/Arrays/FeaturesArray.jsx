export const featuresComponents = ({ text }) => {
  return [
    <section className="text-black my-24 max-w-[1000px] mx-auto">
      <div className="flex flex-col justify-center items-center text-center">
        <h1 className="text-3xl font-bold my-2 text-center">Features</h1>
    ...
    <section className="text-black my-24 max-w-[1000px] mx-auto flex max-lg:flex-col gap-5 max-lg:gap-0 items-start max-lg:px-6">
